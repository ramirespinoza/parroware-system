                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border py-3 px-6 text-center">
                                    <button wire:click="edit({{ $community->id }})" class="bg-yellow-500 text-white px-2 py-1 rounded">Editar</button>
                                    <button wire:click="delete({{ $community->id }})" class="bg-red-500 text-white px-2 py-1 rounded">Eliminar</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
