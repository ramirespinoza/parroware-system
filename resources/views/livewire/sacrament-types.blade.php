                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border py-3 px-6 text-center">
                                <button wire:click="edit({{ $sacrament_type->id }})" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit</button>
                                <button wire:click="delete({{ $sacrament_type->id }})" class="bg-red-500 text-white px-2 py-1 rounded">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
