    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div class="flex flex-col items-center space-y-4 self-end px-4 py-2 rounded m-2 grid">
                <button class="self-end bg-blue-500 text-black px-4 py-2 rounded m-2"><x-nav-link class="text-white" href="{{ route('sacrament-types') }}" :active="request()->routeIs('sacrament-types')">
                    {{ __('Tipos de sacramentos') }}
                </x-nav-link></button>
                <button class="self-end bg-blue-500 text-black px-4 py-2 rounded m-2"><x-nav-link class="text-white" href="{{ route('certificates') }}" :active="request()->routeIs('certificates')">
                    {{ __('Certificados') }}
                </x-nav-link></button>
            </div>
        </div>
